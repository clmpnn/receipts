...
def clear_receipts():
    ...
    try:
        with get_db() as conn:
            ...
            conn.commit()
        return {"ok": True, "message": "All receipts cleared"}
    except Exception as e:
...
<body>
    <div class="container">
        ...
        <div class="grid">
            ...
            <div class="card">
                ...
                <h2>All Transactions <button id="clearBtn" style="width:auto;padding:4px 10px;font-size:12px;background:#da3633;">Clear All</button></h2>
    ...
    <script>
        ...
        document.getElementById("clearBtn").addEventListener("click", async () => {
            if (!confirm("This will permanently delete all receipts. Continue?")) return;
            try {
